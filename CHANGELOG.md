...
## [v0.4.2](https://github.com/containers/youki/compare/v0.4.1...v0.4.2) - 2024-10-29
### 🐛 Bug Fixes
- Fixed ENAMETOOLONG error in setup_console_socket by @morganllewellynjones in https://github.com/containers/youki/pull/2915
- fix(libcontainer) no_pivot args is not used by @xujihui1985 in https://github.com/containers/youki/pull/2923
...
- print "unknown" instead of defaults if we cannot get kernel config by @YJDoc2 in https://github.com/containers/youki/pull/2964
### Other Changes
